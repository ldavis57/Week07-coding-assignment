...
let difference = ages.at(- 1) - ages.at(0);
...
let newDifference = ages.at(- 1) - ages.at(0);
...
console.log("Last name in array:", lastElement);
...
console.log("First name in array:", firstElement);
...
function repeatWord(word, n) {
    return word.repeat(n); // or use a loop if preferred
}

console.log(repeatWord("Hello", 8)); // Output: HelloHelloHello
...
console.log(getFullName("Lana", "Davis")); // Output: Lana Davis
